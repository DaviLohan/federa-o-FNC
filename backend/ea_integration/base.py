...
CELERY_BEAT_SCHEDULE = {
    'auto-initialize-league-championships-every-1-min': {
    ...
    'finalize-monthly-player-ranking-cycle': {
        'task': 'player_stats.finalize_monthly_player_ranking_cycle',
...
EA_RELAY_URL = config('EA_RELAY_URL', default='')
EA_RELAY_TOKEN = config('EA_RELAY_TOKEN', default='')
EA_RELAY_VERIFY_SSL = config('EA_RELAY_VERIFY_SSL', default=True, cast=bool)
