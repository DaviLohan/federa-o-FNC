          ...
          <div className="bg-surface1 rounded-3xl p-8">
            <div className="flex items-center gap-8">
              ...
              <div className="flex-1">
                ...
                <div className="text-6xl md:text-7xl font-mono font-bold gradient-text mb-4 tracking-tight">
                ...
                <div className="flex flex-wrap gap-3 items-center">
                  ...
                  <p className="text-sm text-muted flex-1 min-w-[250px]">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Input
                  ...
                  onChange={(e) =>
                    setPlayerData({ ...playerData, birth_date: e.target.value })
                  }
                  required
                />
                <Input
