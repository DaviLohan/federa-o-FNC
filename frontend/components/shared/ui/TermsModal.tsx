...
const sections = [
  {
    ...
    content: `Ao criar uma conta, registar uma equipa ou participar de qualquer campeonato organizado através da plataforma IMPERIUM, o utilizador declara ter lido, compreendido e aceite integralmente os presentes Termos e Condições de Uso. Caso não concorde com qualquer disposição aqui prevista, deverá cessar imediatamente o uso da plataforma.

Estes termos constituem um acordo legalmente vinculativo entre o utilizador e a IMPERIUM Platform. A plataforma reserva-se o direito de alterar estes termos a qualquer momento, mediante notificação prévia de 15 (quinze) dias, exceto em casos de urgência ou obrigação legal que exijam alteração imediata.`,
  },
  {
    number: '02',
...
As equipas podem ser inscritas em campeonatos organizados pela IMPERIUM, sujeito à disponibilidade de vagas e ao cumprimento dos requisitos mínimos de cada competição. A inscrição em campeonatos implica a aceitação das regras específicas de cada competição, que complementam estes Termos e Condições.

A IMPERIUM reserva-se o direito de recusar a inscrição de equipas que tenham historial de violações graves das regras, comportamento antidesportivo comprovado ou pendências administrativas por resolver.`,
  },
  {
    number: '04',
...
A equipa visitante dispõe de um prazo de 48 (quarenta e oito) horas após a submissão da súmula para contestar o resultado, caso considere que o mesmo não reflete a realidade. As contestações serão analisadas pela administração da IMPERIUM no prazo de 5 (cinco) dias úteis, tendo em conta as evidências fornecidas por ambas as partes.
...
Penalidades podem ser aplicadas a jogadores individuais, aos donos de equipas e às próprias equipas, conforme a natureza e responsabilidade na infração.`,
  },
  {
    ...
    content: `A IMPERIUM recolhe e trata dados pessoais dos utilizadores em conformidade com a legislação de proteção de dados aplicável (RGPD e legislação nacional). Os dados recolhidos destinam-se exclusivamente à prestação dos serviços da plataforma, gestão de campeonatos e comunicação com os utilizadores. Não são partilhados com terceiros para fins comerciais sem consentimento expresso.
...
Todo o conteúdo da plataforma IMPERIUM, incluindo o logo, design, nomenclatura, sistema de pontuação e algoritmos de classificação, é propriedade exclusiva da IMPERIUM e encontra-se protegido por direitos de propriedade intelectual. A reprodução, distribuição ou uso não autorizado de qualquer conteúdo da plataforma é expressamente proibida.
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            {/* ── Header ────────────────────────────────────────────────── */}
            <div className="relative flex items-start justify-between gap-4 px-6 pt-7 pb-5 border-b border-border flex-shrink-0">
              ...
              <div className="relative flex items-center gap-4">
                ...
                <div>
                  ...
                  <h2 className="font-heading text-2xl font-black uppercase tracking-wide bg-clip-text text-transparent bg-gradient-to-r from-gold via-gold2 to-gold leading-tight">
                    Termos e Condições
                  </h2>
              ...
              <button
                onClick={onClose}
                className="relative flex-shrink-0 w-9 h-9 rounded-xl border border-border flex items-center justify-center
            ...
            >
              ...
              <p className="text-sm text-muted leading-relaxed">
                Estes Termos e Condições regem o uso da plataforma IMPERIUM. Leia atentamente
              ...
              <div className="p-4 rounded-2xl border border-gold/15 bg-gold/5 flex gap-3">
                ...
                <p className="text-xs text-muted leading-relaxed">
                  Ao utilizar a plataforma IMPERIUM, confirma que leu e compreendeu estes
            ...
            {/* ── Footer ────────────────────────────────────────────────── */}
            <div className="relative flex items-center justify-between gap-4 px-6 py-4 border-t border-border flex-shrink-0">
              <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent pointer-events-none" />
              <p className="relative text-xs text-muted">
                © 2026 IMPERIUM. Todos os direitos reservados.
              </p>
              <button
                onClick={onClose}
