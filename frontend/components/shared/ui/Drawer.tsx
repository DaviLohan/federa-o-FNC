  ...
  return (
    <>
      ...
      >
        ...
        {/* Header */}
        <div className="sticky top-0 bg-surface1 border-b border-border px-4 py-3 sm:px-6 sm:py-4 z-10">
          <div className="flex justify-between items-start">
            ...
            <button
              onClick={onClose}
              className="text-muted hover:text-text transition-colors p-2 hover:bg-surface2 rounded-lg"
        ...
        {/* Actions Footer */}
        {actions && (
          <div className="sticky bottom-0 bg-surface1 border-t border-border px-4 py-3 sm:px-6 sm:py-4">
