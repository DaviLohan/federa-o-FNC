  ...
  return (
    <div className="flex gap-1.5 mt-1.5">
      <button
        ...
        disabled={busy}
        className="px-2 py-1 rounded text-[11px] font-semibold bg-gold/10 text-gold border border-gold/30 hover:bg-gold/20 transition-colors disabled:opacity-50"
      >
      ...
      <button
        ...
        disabled={busy}
        className="px-2 py-1 rounded text-[11px] font-semibold bg-surface2 text-muted border border-border hover:text-text transition-colors disabled:opacity-50"
      >
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        {/* Actions */}
                        <div className="flex flex-col gap-1 opacity-100 sm:opacity-0 sm:transition-opacity sm:group-hover:opacity-100">
                          {!notification.is_read && (
                            <button
